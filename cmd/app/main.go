...
import (
	...
	"github.com/marcostota/imersao/internal/infra/akafka"
...
func main() {
	...
	createListProductUsecase := usecase.NewListProductUseCase(repository)

	productHandlers := web.NewProductHandlers(createProductUseCase, createListProductUsecase)
